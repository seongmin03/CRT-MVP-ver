export interface TravelTip {
  ...
  export const travelTips: Record<string, TravelTip[]> = {
    ...
    "서유럽": [
      { title: "온라인 예약 권장", content: "현장 발권이 어려운 경우가 많아요. 온라인 예약을 권장합니다!" },
      { title: "무료 식수(Tap Water)", content: "식당에서 Tap water(수돗물)을 요청하면 무료 제공하는 경우가 있어요." },
      { title: "파업 대비 일정", content: "대중교통 파업에 대비한 대안 일정을 생각해두세요!" },
      { title: "소매치기 주의", content: "소매치기를 주의하세요. 서명, 설문, 팔찌 등의 친절한 접근을 유의하세요!" }
    ],
    "동유럽": [
      { title: "현지 통화 필요", content: "유로화가 아닌 현지 통화가 필요한 경우가 있어요." },
      { title: "편한 운동화 추천", content: "조약돌 길이 매우 흔해요! 편한 운동화를 추천해요." },
      { title: "현지 통화 결제", content: "카드 결제 시 현지 통화를 선택하면 수수료를 줄이는 데 유리한 경우가 많아요!" }
    ],
    "북유럽": [
      { title: "식비 절약은 마트에서", content: "식비가 부담된다면 마트를 이용하세요." },
      { title: "렌터카 이용 권장", content: "장거리 이용이 잦아서 렌터카가 효율적일 수 있어요!" },
      { title: "주류 구매 주의", content: "술을 일반 마트가 아닌 국가 운영 주류 판매점에서만 정해진 시간에 살 수 있어요." }
    ],
    "남유럽": [
      { title: "시에스타 확인", content: "시에스타로 인해 낮 시간에는 상점들이 문을 닫는 경우가 있어요." },
      { title: "늦은 저녁 식사 문화", content: "저녁식사를 비교적 늦게 시작하는 편이니 참고하세요!" },
      { title: "자외선 차단제 필수", content: "햇볕이 매우 강해서 자외선 차단제는 필수입니다!" },
      { title: "편한 신발 준비", content: "언덕과 계단이 많은 도시라 편한 신발을 준비하세요." }
    ],
    "싱가포르": [
